...
object StreamsExercise {
  ...
  /**
    ...
    */
  lazy val fibs: Stream[Int] = fibFrom(1, 1)
  ...
  /**
    ...
    */
  def maxFixedDigitsNumber(digits: Int): Int = math.pow(10, digits).toInt - 1
  ...
  /**
    ...
    */
  def sumOfDigits(number: Int): Int = number.toString.map(_.asDigit).sum
  ...
  /**
    ...
    *      has "asDigit" method to get its value
    */
  def sumOfDigitsPowThree(number: Int): Int =  number.toString.map(_.asDigit).map(math.pow(_, 3).toInt).sum
  ...
  /**
    ...
    */
  val capOfDigitsSizeTask1: Int = (from(1) filter (x => math.pow(10, x-1) > x*4374)).head - 1
  ...
  /**
    ...
    */
  lazy val rangeStreamTask1: Stream[Int] = Stream.range(1, maxFixedDigitsNumber(capOfDigitsSizeTask1))

  /**
    * The stream of all numbers satisfying Task1 condition.
    */
  lazy val resultStreamTask1: Stream[Int] = rangeStreamTask1 filter (x => x == sumOfDigitsPowThree(x))
